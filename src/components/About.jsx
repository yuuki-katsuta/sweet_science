  ...
  return (
    <div>
      ...
      <div style={{ textAlign: 'left' }}>
        <p>
          本アプリでは、ボクシングの採点結果についてに談論・ディスカッションすることができます。
          <br />
          ...
          また、ボクシング愛するコアなファンの意見を知り、知見を広げることでその奥深さ、魅力をを伝えられると思います。
          <br />
          ボクシングのスコアリングシステムは、時に多くの議論と論争を引き起こすかもしれませんが、健全なチャットにご協力お願いします！
          <br />
        </p>
      </div>
      ...
      <div style={{ textAlign: 'left', marginBottom: '60px' }}>
        ...
        <p>
          ...
          その為、優劣が微妙な試合の場合、地元選手に有利な判定が起きてしまうことが無いとはいえない。
          また無観客試合の場合、パンチによる音の大きさに左右されてしまう可能性もある。
        </p>
        <p>
